...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tattoos', function (Blueprint $table) {
            ...
            $table->foreignId('studio_id')->nullable()->constrained()->onDelete('no action')->onUpdate('no action');
            $table->foreignId('primary_style_id')->nullable()->constrained('styles', 'id')->onDelete('no action')->onUpdate('no action');
