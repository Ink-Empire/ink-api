...
class TattooApprovedNotification extends Notification
{
    use RespectsEmailPreferences, RespectsPushPreferences;

    public const EVENT_TYPE = 'tattoo_approved';
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("Your tattoo has been approved by {$this->artist->name} - InkedIn")
            ->view('mail.tattoo-approved', [
    ...
    public function toFcm(object $notifiable): FcmMessage
    {
        return (new FcmMessage(notification: new FcmNotification(
            title: 'Tattoo approved',
            body: "Your tattoo has been approved by {$this->artist->name} and is now visible in the feed.",
        )))
            ->data([
                'type' => self::EVENT_TYPE,
