...
<head>
    ...
    <title>New Tattoo Tag - InkedIn</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                                        <h1 style="margin: 0 0 16px 0; font-size: 36px; font-weight: 700; color: #ffffff;">New Tattoo Tag</h1>
                                        <p style="margin: 0; font-size: 18px; line-height: 1.5; color: #888888;">
                                            Someone tagged you as the artist on their tattoo.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 32px 40px 40px 40px;">
                                        <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.7; color: #aaaaaa;">
                                            <strong style="color: #ffffff;">{{ $uploaderName }}</strong> tagged you as the artist on their tattoo. Tap below to review and approve or reject the tag.
                                        </p>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="padding: 8px 0 32px 0;">
                                                    <a href="{{ $reviewUrl }}" style="display: inline-block; padding: 16px 48px; background-color: #D4A853; color: #1a1a1a; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 30px;">
                                                        Review Tattoo
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #666666; text-align: center;">
                                            If you approve, the tattoo will appear on your profile and in the main feed.
                                        </p>
                                    </td>
                                </tr>
                            </table>
