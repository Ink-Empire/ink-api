...
<head>
    ...
    <title>Affiliation Accepted - InkedIn</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                                        <h1 style="margin: 0 0 16px 0; font-size: 36px; font-weight: 700; color: #ffffff;">
                                            @if($acceptedByType === 'artist')
                                                New Artist Joined!
                                            @else
                                                Request Approved!
                                            @endif
                                ...
                                <tr>
                                    <td style="padding: 32px 40px 40px 40px;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                                            <tr>
                                                <td align="center" style="padding: 20px; background-color: #252525; border-radius: 12px;">
                                                    <p style="margin: 0; font-size: 16px; color: #D4A853; font-weight: 600;">
                                                        @if($acceptedByType === 'artist')
                                                            {{ $accepterName }} is now a verified member of {{ $studioName }}
                                                        @else
                                                            You are now a verified member of {{ $studioName }}
                                                        @endif
                                                    </p>
                                                </td>
                                            </tr>
