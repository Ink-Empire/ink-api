                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #1a1a1a;">You've Been Invited!</h2>

                            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #555555;">
                                <strong style="color: #1a1a1a;">{{ $inviterName }}</strong> has invited you to join <strong style="color: #1a1a1a;">{{ $studioName }}</strong> on InkedIn.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 0;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding: 12px 20px; font-size: 14px; color: #666666; border-bottom: 1px solid #f0f0f0;">Studio Name</td>
                                                <td style="padding: 12px 20px; font-size: 14px; color: #1a1a1a; text-align: right; font-weight: 500; border-bottom: 1px solid #f0f0f0;">{{ $studioName }}</td>
                                            </tr>
                                            @if($studioLocation)
                                            <tr>
                                                <td style="padding: 12px 20px; font-size: 14px; color: #666666;">Location</td>
                                                <td style="padding: 12px 20px; font-size: 14px; color: #1a1a1a; text-align: right; font-weight: 500;">{{ $studioLocation }}</td>
                                            </tr>
                                            @endif
                                        </table>
                                    </td>
