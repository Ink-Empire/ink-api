                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" style="padding: 0 0 32px 0;">
                            <img src="{{ config('app.frontend_url') }}/assets/images/inkedin-logo.png" alt="InkedIn" width="200" style="display: block; height: auto;">
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                                        <h1 style="margin: 0 0 16px 0; font-size: 36px; font-weight: 700; color: #ffffff;">Reset Your Password</h1>
                                ...
                                <tr>
                                    <td style="padding: 32px 40px 40px 40px;">
                                        ...
                                        <div style="padding: 20px; background-color: #111111; border-radius: 8px;">
                                            <p style="margin: 0 0 12px 0; font-size: 14px; font-weight: 600; color: #ffffff;">
                                                Password Requirements:
                                            </p>
                                            <ul style="margin: 0; padding-left: 20px; font-size: 13px; line-height: 1.8; color: #aaaaaa;">
