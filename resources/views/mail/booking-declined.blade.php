                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                                        <h1 style="margin: 0 0 16px 0; font-size: 36px; font-weight: 700; color: #ffffff;">{{ ucfirst($type) }} Request Update</h1>
                                        <p style="margin: 0; font-size: 18px; line-height: 1.5; color: #888888;">
                                            Unfortunately, <strong style="color: #ffffff;">{{ $artistName }}</strong> is unable to accommodate your {{ $type }} request at this time.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 32px 40px 40px 40px;">
                                            ...
                                            <tr>
                                                <td style="padding: 0;">
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td style="padding: 12px 20px; font-size: 14px; color: #666666; border-bottom: 1px solid #333333;">Date</td>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                                            <tr>
                                                <td style="padding: 16px 20px; background-color: #252525; border-radius: 12px; border-left: 4px solid #D4A853;">
                                                    <p style="margin: 0 0 4px 0; font-size: 12px; font-weight: 600; color: #D4A853; text-transform: uppercase;">Message from artist</p>
                                                    <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #aaaaaa;">{{ $reason }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                        @endif
