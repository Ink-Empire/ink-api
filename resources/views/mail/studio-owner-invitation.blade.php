...
<head>
    ...
    <title>Claim Your Studio - InkedIn</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                                        <h1 style="margin: 0 0 16px 0; font-size: 36px; font-weight: 700; color: #ffffff;">Is this your studio?</h1>
                                        <p style="margin: 0; font-size: 18px; line-height: 1.5; color: #888888;">
                                            Claim your studio profile and start managing your presence on InkedIn.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 32px 40px 40px 40px;">
                                        ...
                                        <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.7; color: #aaaaaa;">
                                            <strong style="color: #ffffff;">{{ $clientName }}</strong> thinks you might own <strong style="color: #ffffff;">{{ $studioName }}</strong> on InkedIn. Claim your studio profile to manage your page, showcase your artists, and connect with new clients.
                                        </p>
                                        ...
                                        <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #666666; text-align: center;">
                                            Join studios already growing their client base on InkedIn.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 32px 40px; text-align: center;">
                            ...
                            <p style="margin: 8px 0 0 0; font-size: 12px; color: #444444;">
                                You received this email because someone suggested you may own this studio on InkedIn.
                            </p>
                        </td>
                    </tr>
                </table>
